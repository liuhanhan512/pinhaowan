...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         * @param header The currently sticky header being offset. This header
         *            is not guaranteed to have it's measurements set. It is
         ...
         * @param offset The amount the sticky header is offset by towards to
         *            top of the screen.
         */
    ...
    public int getListPaddingTop(){
        return mList.getChildAt(0).getPaddingTop();
    }
    public int getFixedFirstVisibleItem(){
        return mList.getFixedFirstVisibleItem();
    }
    ...
    public View getFirstHeaderView(){
        View header = mAdapter.getHeaderView(0, null, mList);
        return header;
    }

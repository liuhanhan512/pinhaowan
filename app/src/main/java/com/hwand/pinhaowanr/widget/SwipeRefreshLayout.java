...
//    private static final int REFRESH_TRIGGER_DISTANCE = 120;
    ...
    public boolean canChildScrollUp() {
        if (android.os.Build.VERSION.SDK_INT < 14) {
            ...
            } else if(mTarget instanceof StickyListHeadersListView){
                final StickyListHeadersListView absListView = (StickyListHeadersListView) mTarget;
                return absListView.getChildCount() > 0
                        && (absListView.getFirstVisiblePosition() > 0 || absListView.getChildAt(0)
                        .getTop() < absListView.getPaddingTop());
            }
            ...
            if(mTarget instanceof StickyListHeadersListView){
                final StickyListHeadersListView absListView = (StickyListHeadersListView) mTarget;
                AbsListView listView = absListView.getWrappedList();

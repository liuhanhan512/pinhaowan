 ...
 */
public class WeixinGroupShareUnit extends BaseShareUnit {
    private Context mContext;
    public WeixinGroupShareUnit(Context context){
        super(new ShareUnitInfoFactory(context).createWeixinGroupInfo());
        mContext = context;
    }
    @Override
    public void share(ShareInfo shareInfo) {
        ...
        ShareToManager.getInstance().getWeiXinExecutor().doShareHypeLink(title, content, null,
                compressImageBySize(defaultBitmap, 30),picUrl, true, null);
    }
}
